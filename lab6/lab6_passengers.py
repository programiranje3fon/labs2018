...
# - passport - passenger's passport number (as string)
...
#
# Use appropriate decorators to create get and set methods for the passport attribute;
...
#   the FlightServices enum: snack, free_ejournal
...
#   the FlightServices enum: priority_boarding, selection_of_food_and_drinks, free_onboard_wifi
